...
class Home extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if (get_frontend_settings('site_status') == 'active') {
            $this->home();
        } elseif (get_frontend_settings('site_status') == 'inactive') {
            $this->login();
        } else {
            $this->home();
        }
    ...
    public function my_courses()
    {
        ...
        $page_data['page_title'] = 'Meus Cursos';
        $this->load->view('frontend/' . get_frontend_settings('theme') . '/index', $page_data);
    }
    ...
    public function lesson($slug = "", $course_id = "", $lesson_id = "")
    {
        ...
        $lesson_id2 = $this->crud_model->update_last_played_lesson($course_id, $lesson_id);
    ...
    public function login()
    {
        ...
        $this->load->view('frontend/login_1', $page_data);
    ...
    public function certificates()
    {
        ...
        $page_data['page_title'] = 'Meus Certificados';
        $this->load->view('frontend/' . get_frontend_settings('theme') . '/index', $page_data);
    }
